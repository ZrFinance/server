...
class Users(models.Model):
    ...
    freeze_bonus =  models.IntegerField(verbose_name="股权分红冻结",default=0,null=True)
    freeze_spread = models.IntegerField(verbose_name="推广股权冻结", default=0, null=True)
    shopbal = models.IntegerField(verbose_name="商城鑫鑫币", default=0, null=True)
    spreadstop = models.IntegerField(verbose_name="推广股权冻结,暂时没用到",default=0,null=True)
