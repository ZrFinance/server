...
class Users(models.Model):
    ...
    lastindex = models.IntegerField(default=0,verbose_name='上一次指定转盘奖品索引')
    status = models.IntegerField(default='1',verbose_name="状态:0-正常,1-未激活,2-禁用")
    activation = models.IntegerField(verbose_name="激活码",default=0)
    buypower = models.IntegerField(verbose_name="认筹权",default=0)
    integral = models.IntegerField(verbose_name='VIP分',default=0)
    bonus =  models.IntegerField(verbose_name="股权分红",default=0)
    spread = models.IntegerField(verbose_name="推广股权",default=0)
    idcard=models.CharField(max_length=20,verbose_name="身份证号",default='')
    name=models.CharField(max_length=60,verbose_name="真实姓名",default='')
    alipay=models.CharField(max_length=60,verbose_name="支付宝",default='')
    wechat=models.CharField(max_length=60,verbose_name="微信",default='')
    bank=models.CharField(max_length=60,verbose_name="银行名称",default='')
    bank_account=models.CharField(max_length=60,verbose_name="银行账户",default='')
